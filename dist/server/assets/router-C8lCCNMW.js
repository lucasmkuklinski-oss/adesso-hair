...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: `fixed top-0 left-0 right-0 z-50 transition-colors duration-500 ${isHome ? "bg-transparent" : "bg-background/95 backdrop-blur-sm border-b border-border"}`, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto flex items-center justify-between px-6 py-5", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-display text-2xl tracking-[0.15em] font-light", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: isHome ? "text-primary-foreground" : "text-foreground", children: "ADESSO" }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "hidden md:flex items-center gap-10", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: `nav-link ${isHome ? "nav-link-light" : ""}`, children: "Home" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: `nav-link ${isHome ? "nav-link-light" : ""}`, children: "Services" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/book", className: `nav-link ${isHome ? "nav-link-light" : ""}`, children: "Book" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/visit", className: `nav-link ${isHome ? "nav-link-light" : ""}`, children: "Visit" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+15196869999", className: `nav-link ${isHome ? "nav-link-light" : ""}`, children: "(519) 686-9999" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block w-6 h-px bg-current transition-transform duration-300 ${menuOpen ? "rotate-45 translate-y-[3.5px]" : ""}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block w-6 h-px bg-current transition-opacity duration-300 ${menuOpen ? "opacity-0" : ""}` }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: `block w-6 h-px bg-current transition-transform duration-300 ${menuOpen ? "-rotate-45 -translate-y-[3.5px]" : ""}` })
          ]
        }
      )
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { children: menuOpen && /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col items-center gap-6 py-8", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "nav-link", onClick: () => setMenuOpen(false), children: "Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "nav-link", onClick: () => setMenuOpen(false), children: "Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/book", className: "nav-link", onClick: () => setMenuOpen(false), children: "Book" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/visit", className: "nav-link", onClick: () => setMenuOpen(false), children: "Visit" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+15196869999", className: "nav-link", children: "(519) 686-9999" })
        ] })
      }
    ) })
  ] });
...
function Footer() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-primary text-primary-foreground section-padding", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-display text-3xl tracking-[0.15em] font-light mb-4", children: "ADESSO" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/60 text-sm leading-relaxed", children: "Hair & Beauty" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-body text-xs tracking-[0.2em] uppercase mb-6 text-primary-foreground/40", children: "Navigate" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "flex flex-col gap-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/", className: "text-sm text-primary-foreground/70 hover:text-accent-pop-light transition-colors", children: "Home" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/services", className: "text-sm text-primary-foreground/70 hover:text-accent-pop-light transition-colors", children: "Services" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/book", className: "text-sm text-primary-foreground/70 hover:text-accent-pop-light transition-colors", children: "Book Appointment" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/visit", className: "text-sm text-primary-foreground/70 hover:text-accent-pop-light transition-colors", children: "Hours & Location" })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "text-body text-xs tracking-[0.2em] uppercase mb-6 text-primary-foreground/40", children: "Contact" }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col gap-3 text-sm text-primary-foreground/70", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("a", { href: "tel:+15196869999", className: "hover:text-accent-pop-light transition-colors", children: "(519) 686-9999" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { children: [
            "25 Base Line Rd W",
            /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
            "London, ON N6J 1V1"
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary-foreground/40 text-xs mt-2", children: "Entrance from McGregor Ave" })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 pt-8 border-t border-primary-foreground/10 text-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-primary-foreground/30 tracking-wider", children: [
      "© ",
      (/* @__PURE__ */ new Date()).getFullYear(),
      " Adesso Hair & Beauty. All rights reserved."
    ] }) })
  ] }) });
}
const appCss = "/assets/styles-BzTRFdUW.css";
...
const $$splitComponentImporter$3 = () => import("./visit-cKpi5mDC.js");
const Route$3 = createFileRoute("/visit")({
  head: () => ({
    meta: [{
      title: "Hours & Location — Adesso Hair & Beauty London, ON"
    }, {
      name: "description",
      content: "Visit Adesso Hair & Beauty at 25 Base Line Rd W, London, Ontario N6J 1V1. Open Tuesday–Saturday. Call (519) 686-9999 for appointments."
    }, {
      property: "og:title",
      content: "Hours & Location — Adesso Hair & Beauty London, ON"
    }, {
      property: "og:description",
      content: "25 Base Line Rd W, London, Ontario. Open Tue–Sat. Call (519) 686-9999."
    }],
    links: [{
      rel: "canonical",
      href: "https://adessohair.com/visit"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./services-c0xHNyc-.js");
const Route$2 = createFileRoute("/services")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Browse our full menu of services: haircuts, colour, balayage, manicures, pedicures, waxing, facials, and cosmetic treatments at Adesso Hair & Beauty in London, Ontario."
    }, {
      property: "og:title",
      content: "Hair & Beauty Services — Adesso Salon London, ON"
    }, {
      property: "og:description",
      content: "Haircuts, colour, nails, waxing, facials and more at Adesso Hair & Beauty in London, Ontario."
    }],
    links: [{
      rel: "canonical",
      href: "https://adessohair.com/services"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./book-C2bNYYvx.js");
const Route$1 = createFileRoute("/book")({
  head: () => ({
    meta: [{
      title: "Book an Appointment — Adesso Hair & Beauty"
    }, {
      name: "description",
      content: "Request a booking at Adesso Hair & Beauty in London, Ontario. Choose your stylist, preferred date, and service."
    }, {
      property: "og:title",
      content: "Book an Appointment — Adesso Hair & Beauty"
    }, {
      property: "og:description",
      content: "Request a booking at Adesso Hair & Beauty. Choose your stylist and preferred date."
    }],
    links: [{
      rel: "canonical",
      href: "https://adessohair.com/book"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-DKlPFBBD.js");
const Route2 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Adesso Hair & Beauty is a premier salon in London, Ontario offering expert haircuts, colour, styling, manicures, pedicures, waxing, cosmetic and facial treatments. Call (519) 686-9999."
    }, {
      property: "og:title",
      content: "Adesso Hair & Beauty — Premium Salon in London, Ontario"
    }, {
      property: "og:description",
      content: "Expert hair styling, nail care, waxing, and beauty treatments in London, Ontario. Book your appointment today."
    }],
    links: [{
      rel: "canonical",
      href: "https://adessohair.com"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const VisitRoute = Route$3.update({
  id: "/visit",
  path: "/visit",
...
const BookRoute = Route$1.update({
  id: "/book",
  path: "/book",
  getParentRoute: () => Route$4
});
